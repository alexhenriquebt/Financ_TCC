			...
			<div class="row">
				<div class="col-12 col-md-6 bloco-entrar">
					<div class="card_entrar">
						...
						<form action="../model/validarLogin.php" class="form" method="post">
							...
							<div class="text-center p-2">
								...
								<div class="text-center">
									<a href="recuperarSenha/recuperarSenhaEmail.php" class="text-dark">Esqueci minha senha</a>
								</div>
							</div>
				...
				<div class="col-12 col-md-6 bloco-img-login">
					...
					" src="../assets/images/imgLogin.png" alt="ícone com gráficos - remetendo a finanças">
					<div class="">
						<a class="btn-wrap" href="cadastrar.php"><button class="btn btn-danger w-50">Não tem uma conta?
								Clique aqui</button></a>
					</div>
				</div>
				<!-- ------------------------- img fim ------------------------- -->
