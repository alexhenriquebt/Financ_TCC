			...
			<div class="row">
				<div class="col-12">
					<div class="cardRecuperar">
						<h3 class="text-center mt-3 mb-5">Confirmar código</h3>
						<form action="../../model/recuperarSenha/confirmarCodigo.php" class="form" method="post">
							<div class="p-2">
								<label>Insira o código:</label>
								<input type="text" class="box w-100" name="codigo" placeholder="Código" required>
							</div>
