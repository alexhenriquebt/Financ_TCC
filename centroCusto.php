...
if ($centroCusto['lanSituacao'] === 'Realizado') {
  echo '<i class="bi bi-check-circle-fill text-success"></i>';
                      ...
                      <td class="text-danger">
                        <?php echo DateTime::createFromFormat('Y-m-d', $centroCusto['lanVencimento'])->format('d/m/Y') ?>
                      </td>
                      ...
                      <td>
                        <a href="../model/deletarCentroCusto.php?cenIdDeletar=<?php echo $listaCentroCusto[$index]['cenId']; ?>"
                          onclick="return confirm('Você realmente deseja excluir?')">
          ...
          <div class="col-12 col-lg-3 g-3 mb-5 text-center">
            <?php if ($saldo < 0) {
              ?>
              <div class="container-estilizado p-3 text-danger">
                <?php
            } else {
              ?>
                <div class="container-estilizado p-3 mt-3 text-success">
                  <?php
            }
            ?>
                <h5>Saldo<br>
              ...
              <div class="container-estilizado p-3 mt-3 text-danger">
                <h5>Despesas<br>
                  <?php
                  if ($despesas == 0) {
                    echo 'R$ 0';
                ...
                <div class="container">
                  <div class="row">
                    ...
                    foreach ($maioresGastosCategoria as $index => $categoriaDespesa) {
                      ...
                      <p class="col-4">
                        <?php echo 'R$ ' . number_format(abs($categoriaDespesa['totalValor']), 2, ',', '.'); ?></p>
                      <hr>
                      <?php
                    }
                    ?>
  ...
  <dialog id="modalAlterar">
    <div class="container">
      <form class="row g-3" action="../model/alterarCentroCusto.php?id_update=<?php echo $resCentroUpdate['cenId']; ?>"
        method="post">
        <h4>Alterar <?php echo $resCentroUpdate['cenTipo'] . ': ' . $resCentroUpdate['cenNome'] ?></h4>

        <div class="col-12 col-md-8">
          <label>Nome</label>
          <input type="text" name="nome" placeholder="Nome da despesa" class="form-control" value="<?php if (isset($resCentroUpdate)) {
            echo $resCentroUpdate['cenNome'];
          } ?>" required>
        </div>
        
        <div class="col-12 col-md-12">
          <label>Descrição</label>
          <textarea name="descricao" placeholder="Descrição" class="form-control"><?php if (isset($resCentroUpdate)) {
            echo $resCentroUpdate['cenDescricao'];
          } ?></textarea>
    </div>
    ...
    <div class="col-12 col-md-6">
    <label>Prazo de vencimento</label>
<input type="date" name="vencimento" class="form-control" value="<?php if (isset($resCentroUpdate)) {
    echo $resCentroUpdate['lanVencimento'];
} ?>" required>
    </div>
